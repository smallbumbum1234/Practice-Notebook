...
--Insert into Cats(name, age, cat_id)
--Values ('Max', 3, 2),
--		('Coupon', 8, 4) 

-- Auto_Increment and set Primary Key after table was Created
-- (Next time Find solution that can change cat_id as a primary key and auto_increment by not adding new column)
ALTER Table Cats
